    ...
    <div className='w-[300px] h-[400px] bg-white p-3 rounded-lg flex flex-col gap-3 shadow-lg hover:border-2 border-green-300 '>
        ...
        <div className='w-full flex justify-between items-center'>
          <div className='text-lg font-bold text-green-500'>
           ...
           <button className='w-full p-3 bg-green-500 rounded-lg  hover:bg-green-400 transition-all text-white ' onClick={()=>{dispatch(AddItem({id:id,name:name,price:price,image:image,qty:1}));toast.success("Item Added ❤️")}}>
            Add to Dish
           </button>
    </div>
  )
